  ...
  return user ? (
    <div className="relative h-full overflow-y-scroll bg-gray-50 p-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-6">
          <div className="bg-white rounded-xl shadow p-1 max-w-md mx-auto flex justify-center items-center">
                  ...
                  <>
                    {post.image_urls.map((image, index) => (
                      ...
                      >
                        ...
                        />
                        <p className="absolute bottom-0 right-0 text-xs p-1 px-3 backdrop-blur-xl text-white group-hover:opacity-100 transition duration-300">
